angular.module('molApp').directive('teamAway', function () {
    return {
        restrict: 'E',
        ...
        controller: ['$scope', 'chartOptions', function ($scope, chartOptions) {
            ...
            if (!$scope.data.leagueData.chartsby || typeof teamChartsBy == 'undefined') {
                ...
                $scope.dataArray = [$scope.commonData.teamSeries.awayAverage];
                ...
                for (var j in teamChartsBy) {
                    for (var i in $scope.teams) {
                        if ($scope.teams[i][$scope.data.leagueData.chartsby] == teamChartsBy[j].short) {
                            ...
                            $scope.dataArray[j].push($scope.commonData.teamSeries.awayAverage[i]);
                        }
                    }
                }

                $scope.dataAll = $scope.commonData.teamSeries.awayAverage;
            }
